...
// import { ValuationsService } from '../valuation/valuation.service';
...
//     let valuation = await this.valuationsService.getLatestValuation(vehicle.id);
    
//     // Create valuation if it doesn't exist
//     if (!valuation) {
//       valuation = await this.valuationsService.createValuation(vehicle.id);
//     }
